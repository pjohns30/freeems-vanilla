...
#define CAN0CTL0 DVUCP(0x0140)
#define CAN1CTL0 DVUCP(0x0180)
#define CAN2CTL0 DVUCP(0x01C0)
#define CAN3CTL0 DVUCP(0x0200)
#define CAN4CTL0 DVUCP(0x0280)

#define CANXCTL1 DVUCP(0x0001)
#define CANXBTR0 DVUCP(0x0002)
#define CANXBTR1 DVUCP(0x0003)
#define CANXRFLG DVUCP(0x0004)
#define CANXRIER DVUCP(0x0005)
#define CANXTFLG DVUCP(0x0006)
#define CANXTIER DVUCP(0x0007)
#define CANXTARQ DVUCP(0x0008)
#define CANXTAAK DVUCP(0x0009)
#define CANXTBSEL DVUCP(0x000A)
#define CANXIDAC DVUCP(0x000B)
#define CANXMISC DVUCP(0x000C)
#define CANXRXERR DVUCP(0x000D)
#define CANXTXERR DVUCP(0x000E)
#define CANXIDAR0 DVUCP(0x000F)
#define CANXIDAR1 DVUCP(0x0010)
#define CANXIDAR2 DVUCP(0x0011)
#define CANXIDAR3 DVUCP(0x0012)
#define CANXIDMR0 DVUCP(0x0013)
#define CANXIDMR1 DVUCP(0x0014)
#define CANXIDMR2 DVUCP(0x0015)
#define CANXIDMR3 DVUCP(0x0016)
#define CANXIDAR4 DVUCP(0x0017)
#define CANXIDAR5 DVUCP(0x0018)
#define CANXIDAR6 DVUCP(0x0019)
#define CANXIDAR7 DVUCP(0x001A)
#define CANXIDMR4 DVUCP(0x001B)
#define CANXIDMR5 DVUCP(0x001C)
#define CANXIDMR6 DVUCP(0x001D)
#define CANXIDMR7 DVUCP(0x001E)
