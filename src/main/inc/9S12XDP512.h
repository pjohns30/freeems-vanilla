...
#define CANT0CTL0 DVUCP(0x0140)
#define CANT1CTL0 DVUCP(0x0180)
#define CANT2CTL0 DVUCP(0x01C0)
#define CANT3CTL0 DVUCP(0x0200)
#define CANT4CTL0 DVUCP(0x0280)

#define CANT0CTL1 DVUCP(0x0141)
#define CANT0BTR0 DVUCP(0x0142)
#define CANT0BTR1 DVUCP(0x0143)
#define CANT0RFLG DVUCP(0x0144)
#define CANT0RIER DVUCP(0x0145)
#define CANT0TFLG DVUCP(0x0146)
#define CANT0TIER DVUCP(0x0147)
#define CANT0TARQ DVUCP(0x0148)
#define CANT0TAAK DVUCP(0x0149)
#define CANT0TBSEL DVUCP(0x014A)
#define CANT0IDAC DVUCP(0x014B)
//#define CAN0MISC DVUCP(0x000D)  // pg439&1334 BOHOLD / BIT0. It might not be defined on CAN3, so it doesn't work with my OLD scheme. If you need it, define it per module ie. #define CAN0MISC DVUCP(0x014D)
#define CANT0RXERR DVUCP(0x014E)
#define CANT0TXERR DVUCP(0x014F)

#define CANT0IDAR0 DVUCP(0x0150)
#define CANT0IDAR1 DVUCP(0x0151)
#define CANT0IDAR2 DVUCP(0x0152)
#define CANT0IDAR3 DVUCP(0x0153)
#define CANT0IDMR0 DVUCP(0x0154)
#define CANT0IDMR1 DVUCP(0x0155)
#define CANT0IDMR2 DVUCP(0x0156)
#define CANT0IDMR3 DVUCP(0x0157)
#define CANT0IDAR4 DVUCP(0x0158)
#define CANT0IDAR5 DVUCP(0x0159)
#define CANT0IDAR6 DVUCP(0x015A)
#define CANT0IDAR7 DVUCP(0x015B)
#define CANT0IDMR4 DVUCP(0x015C)
#define CANT0IDMR5 DVUCP(0x015D)
#define CANT0IDMR6 DVUCP(0x015E)
#define CANT0IDMR7 DVUCP(0x015F)

#define CANT0RXFG DVUCP(0x0160)
#define CANT0RXIDREG0 DVUCP(0x0160)
#define CANT0RXIDREG1 DVUCP(0x0161)
#define CANT0RXIDREG2 DVUCP(0x0162)
#define CANT0RXIDREG3 DVUCP(0x0163)
#define CANT0RXDATASEG0 DVUCP(0x0164)
#define CANT0RXDATASEG1 DVUCP(0x0165)
#define CANT0RXDATASEG2 DVUCP(0x0166)
#define CANT0RXDATASEG3 DVUCP(0x0167)
#define CANT0RXDATASEG4 DVUCP(0x0168)
#define CANT0RXDATASEG5 DVUCP(0x0169)
#define CANT0RXDATASEG6 DVUCP(0x016A)
#define CANT0RXDATASEG7 DVUCP(0x016B)
#define CANT0RXDATALENGTH DVUCP(0x016C)
//Reserved 0x002D
#define CANT0RXTIMESTAMPH DVUCP(0x016E)
#define CANT0RXTIMESTAMPL DVUCP(0x016F)

#define CANT0TXFG DVUCP(0x0170)
#define CANT0TXIDREG0 DVUCP(0x0170)
#define CANT0TXIDREG1 DVUCP(0x0171)
#define CANT0TXIDREG2 DVUCP(0x0172)
#define CANT0TXIDREG3 DVUCP(0x0173)
#define CANT0TXDATASEG0 DVUCP(0x0174)
#define CANT0TXDATASEG1 DVUCP(0x0175)
#define CANT0TXDATASEG2 DVUCP(0x0176)
#define CANT0TXDATASEG3 DVUCP(0x0177)
#define CANT0TXDATASEG4 DVUCP(0x0178)
#define CANT0TXDATASEG5 DVUCP(0x0179)
#define CANT0TXDATASEG6 DVUCP(0x017A)
#define CANT0TXDATASEG7 DVUCP(0x017B)
#define CANT0TXDATALENGTH DVUCP(0x017C)
#define CANT0TXPRIORITY DVUCP(0x017D)
#define CANT0TXTIMESTAMPH DVUCP(0x017E)
#define CANT0TXTIMESTAMPL DVUCP(0x017F)

#define CANT0BASE AVUCP(0x0140)
#define CANT1BASE AVUCP(0x0180)
#define CANT2BASE AVUCP(0x01C0)
#define CANT3BASE AVUCP(0x0200)
#define CANT4BASE AVUCP(0x0280)

#define XCTL1 AVUCP(0x0001)
#define XBTR0 AVUCP(0x0002)
#define XBTR1 AVUCP(0x0003)
#define XRFLG AVUCP(0x0004)
#define XRIER AVUCP(0x0005)
#define XTFLG AVUCP(0x0006)
#define XTIER AVUCP(0x0007)
#define XTARQ AVUCP(0x0008)
#define XTAAK AVUCP(0x0009)
#define XTBSEL AVUCP(0x000A)
#define XIDAC AVUCP(0x000B)
//#define MISC AVUCP(0x000D)  // pg439&1334 BOHOLD / BIT0. It might not be defined on CAN3, so it doesn't work with my OLD scheme. If you need it, define it per module ie. #define MISC AVUCP(0x000D)
#define XRXERR AVUCP(0x000E)
#define XTXERR AVUCP(0x000F)

#define XIDAR0 AVUCP(0x0010)
#define XIDAR1 AVUCP(0x0011)
#define XIDAR2 AVUCP(0x0012)
#define XIDAR3 AVUCP(0x0013)
#define XIDMR0 AVUCP(0x0014)
#define XIDMR1 AVUCP(0x0015)
#define XIDMR2 AVUCP(0x0016)
#define XIDMR3 AVUCP(0x0017)
#define XIDAR4 AVUCP(0x0018)
#define XIDAR5 AVUCP(0x0019)
#define XIDAR6 AVUCP(0x001A)
#define XIDAR7 AVUCP(0x001B)
#define XIDMR4 AVUCP(0x001C)
#define XIDMR5 AVUCP(0x001D)
#define XIDMR6 AVUCP(0x001E)
#define XIDMR7 AVUCP(0x001F)

#define XRXFG AVUCP(0x0020)
#define XRXIDREG0 AVUCP(0x0020)
#define XRXIDREG1 AVUCP(0x0021)
#define XRXIDREG2 AVUCP(0x0022)
#define XRXIDREG3 AVUCP(0x0023)
#define XRXDATASEG0 AVUCP(0x0024)
#define XRXDATASEG1 AVUCP(0x0025)
#define XRXDATASEG2 AVUCP(0x0026)
#define XRXDATASEG3 AVUCP(0x0027)
#define XRXDATASEG4 AVUCP(0x0028)
#define XRXDATASEG5 AVUCP(0x0029)
#define XRXDATASEG6 AVUCP(0x002A)
#define XRXDATASEG7 AVUCP(0x002B)
#define XRXDATALENGTH AVUCP(0x002C)
//Reserved 0x002D
#define XRXTIMESTAMPH AVUCP(0x002E)
#define XRXTIMESTAMPL AVUCP(0x002F)

#define XTXFG AVUCP(0x0030)
#define XTXIDREG0 AVUCP(0x0030)
#define XTXIDREG1 AVUCP(0x0031)
#define XTXIDREG2 AVUCP(0x0032)
#define XTXIDREG3 AVUCP(0x0033)
#define XTXDATASEG0 AVUCP(0x0034)
#define XTXDATASEG1 AVUCP(0x0035)
#define XTXDATASEG2 AVUCP(0x0036)
#define XTXDATASEG3 AVUCP(0x0037)
#define XTXDATASEG4 AVUCP(0x0038)
#define XTXDATASEG5 AVUCP(0x0039)
#define XTXDATASEG6 AVUCP(0x003A)
#define XTXDATASEG7 AVUCP(0x003B)
#define XTXDATALENGTH AVUCP(0x003C)
#define XTXPRIORITY AVUCP(0x003D)
#define XTXTIMESTAMPH AVUCP(0x003E)
#define XTXTIMESTAMPL AVUCP(0x003F)


//#define CANX DVUCP(0x001)
